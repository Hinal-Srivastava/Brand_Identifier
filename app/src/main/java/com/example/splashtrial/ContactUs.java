...
public class ContactUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CropImage.activity().start(ContactUs.this);
                //   fromRemoteModel();
            }
        });
    }
    ...
    private void setLabelerFromLocalModel(Uri uri) {
        localModel = new FirebaseAutoMLLocalModel.Builder()
                .setAssetFilePath("BrandIdentification/manifest.json")
                .build();
        try {
            ...
            image = FirebaseVisionImage.fromFilePath(ContactUs.this, uri);
    ...
    private void setLabelerFromRemoteLabel(final Uri uri) {
        FirebaseModelManager.getInstance().isModelDownloaded(remoteModel)
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        if (task.isComplete()) {
                            ...
                            try {
                                ...
                                Toast.makeText(ContactUs.this, "Ml exeception", Toast.LENGTH_SHORT).show();
                            }
                        } else
                            Toast.makeText(ContactUs.this, "Not downloaded", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(ContactUs.this, "err"+e, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                startActivity(intent);
            ...
            public void onFailure(@NonNull Exception e) {
                Log.e("OnFail", "" + e);
                Toast.makeText(ContactUs.this, "Something went wrong! " + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void fromRemoteModel() {
        ...
        remoteModel = new FirebaseAutoMLRemoteModel.Builder("Brand_Logos_202052517400").build();
        ...
        FirebaseModelManager.getInstance().download(remoteModel, conditions)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        CropImage.activity().start(ContactUs.this); // open image crop activity
                    }
                });
    }
}
